...
# -------------------------------------------------------------
print("\nFrequency Distribution of Mean Radius\n")

radius_freq = pd.cut(df["Mean_Radius"], bins=5).value_counts().sort_index()

print(radius_freq)

print("\nFrequency Distribution of Mean Texture\n")

texture_freq = pd.cut(df["Mean_Texture"], bins=5).value_counts().sort_index()

print(texture_freq)

print("\nFrequency Distribution of Mean Perimeter\n")

perimeter_freq = pd.cut(df["Mean_Perimeter"], bins=5).value_counts().sort_index()
...
plt.hist(df["Mean_Radius"], bins=5)
...
# -------------------------------------------------------------
# Histogram : Mean Texture
# -------------------------------------------------------------
plt.figure(figsize=(6,4))

plt.hist(df["Mean_Texture"], bins=5)
...
# -------------------------------------------------------------
# Histogram : Mean Perimeter
# -------------------------------------------------------------
plt.figure(figsize=(6,4))

plt.hist(df["Mean_Perimeter"], bins=5)

plt.title("Histogram of Mean Perimeter")
